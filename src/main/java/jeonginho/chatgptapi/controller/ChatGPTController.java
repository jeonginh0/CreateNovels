...
public class ChatGPTController {
    ...
    @GetMapping("/chat") // GET 요청에 대한 핸들러 메서드. "/bot/chat"
    ...
    public String postGenerateStory(@RequestBody Map<String, String> requestBody, Model model) {
        ...
        String initialPrompt = chatGPTService.generatePrompt(background, main
                , sub1, sub2, setting);
    ...
    public ResponseEntity<?> selectChoice(@RequestBody Map<String, String> requestBody) {
        ...
        String nextPrompt = chatGPTService.generateNextPrompt(prevStory, choice);
        ...
        // 다음 스토리를 함께 반환
        return ResponseEntity.ok().body(nextStory);
    }
}
